# Basictkinter template
from tkinter import*

root=Tk()
root.title("Drving License")
...
# Define the function
def drivingLicense ():
    license_id["text"]=" " + int("6388646424")
    license_name["text"]=" " + str("PRASASTI RAI")
    license_dob["text"]=" " + str("13 December 2009")
    license_address["text"]=" " + str("599BM/004/102 Jahid Nagar Bhaptamau Alamnagar Lucknow")
    license_vehicle_type["text"]=" " + str("TWO , FOUR (WHEELER)")
    
# Create a button
button1=Button(root,text="CREATE MY DRIVING LICENSE", command=drivingLicense)
